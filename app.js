  ...
  startLife() {
    ...
    let timerId = setInterval(() => {
      ...
      if (this.bornTimer === 0) {
        ...
        this.startGame();
        playBoard.style.backgroundColor = '#5d908a';
      }
      if (this.bornTimer === 4) {
        this.playAudio('./public/back.mp3');
        playBoard.style.backgroundColor = '#fff';
      }
    }, 1000);
  }

  startGame() {
    gochiImg.src = this.hero.sleeping;
  }
  endLife() {}
}
  ...
  const heroes = [
    {
      hero: {
        ...
        sleeping: 'https://c.tenor.com/5XS8fR02lnYAAAAi/sleep-nitez.gif',
